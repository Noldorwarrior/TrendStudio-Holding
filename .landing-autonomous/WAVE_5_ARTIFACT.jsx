...
// =============================================================================
// TrendStudio Holding — Landing v1.0 — Wave 5 Artifact (s00–s22 + M1 + M2 + M3 + 6 sims)
// Scope: все W4-секции (s00–s16 + M1/M2/M3) +
//        s17 Press Quotes (carousel), s18 FAQ (search+filter accordion),
//        s19 Distribution (5 channels), s20 Waterfall Interactive (slider),
//        s21 Legal (6 disclaimers), s22 CTA (img18 bg + stats) +
//        6 standard sims (S1 BoxOfficeCalc, S2 OttRevenue, S3 TaxOptimizer,
//                         S4 CashflowProjector, S5 ExitValuator, S6 FeeBreakdown).
...
const NAV_LINKS = [
  ...
  { id: 'waterfall-interactive',label: 'Waterfall 2.0' },
...
// =============================================================================
// App_W5 — root shell (sections s00..s22 + M1 + M2 + M3 + 6 standard sims)
// =============================================================================

export default function App_W5() {
