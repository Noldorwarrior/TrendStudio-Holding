...
def build_comps(wb):
    ...
    ru_deals = [
        ...
        (4, 2021, "Premier (ГПМ)", "Газпром-медиа (internal)", 5.0, 2.0, 8.2, "100%", "Internal consolidation",
         "Консолидация внутри группы ГПМ"),
        (5, 2022, "Kinopoisk (новый виток)", "Яндекс (internal)", 12.0, 2.5, 9.8, "100%", "Strategic",
